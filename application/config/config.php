...
$config['cache_static_path']=$filepathroot.'file/cache/static/';
...
|
*/
$config['log_path'] =$filepathroot.'file/logs/';
...
|
*/
$config['log_file_extension'] =$filepathroot.'file/log_file_extension/';
...
|
*/
$config['cache_path'] =$filepathroot.'file/cache/static/';
$config['cache_path_db'] =$filepathroot.'file/dbcache/';
/*
|--------------------------------------------------------------------------
...
*/
$config['sess_driver'] = 'files';
$config['sess_cookie_name'] = 'Tmon_session_';
$config['sess_save_path'] = $filepathroot.'file/session/'; 
$config['sess_expiration']=(60*60*2); 
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] =(60*60*2);  
$config['sess_regenerate_destroy'] = FALSE;
$config['sess_expire_on_close']	= TRUE;
$config['sess_encrypt_cookie']	= TRUE;
$config['sess_use_database']	= TRUE;
